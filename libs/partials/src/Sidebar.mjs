      ...
      >
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
              {/* Dashboard */}
              <SidebarLinkGroup activecondition={pathname === '/3stats' || pathname.includes('/3stats')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
                        ...
                        className={`block text-slate-200 hover:text-white truncate transition duration-150 ${
                          (pathname === '/3stats' || pathname.includes('/3stats')) && 'hover:text-slate-200'
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                            ...
                            <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                              <path
                                className={`fill-current text-slate-400 ${
                                  (pathname === '/3stats' || pathname.includes('/3stats')) && '!text-indigo-500'
                                }`}
          ...
          <div>
            <h3 className="text-xs uppercase text-slate-500 font-semibold pl-3">
              ...
              <span className="lg:hidden lg:sidebar-expanded:block 2xl:block">Documentation</span>
            </h3>
            <ul className="mt-3">
              {/* Components */}

...
import { React as React4, createRoot } from "/libs/vendors-v00.mjs";
...
import { React as React3 } from "/libs/vendors-v00.mjs";
var Sidebar = () => {
...
createRoot(sideBarElement).render(/* @__PURE__ */ React4.createElement(Sidebar, null));

...
import { React as React2, Link, useContext as useContext2, useNavigate } from "/libs/vendors-v0.0.1.mjs";

// pnp:/home/mamluk/3pass/esm-pwa/pkgs/auth/firebase.mjs
...
import { React, useState, Navigate, useLocation, createContext, useContext } from "/libs/vendors-v0.0.1.mjs";
...
var AuthProvider = ({ children }) => {
  ...
  return /* @__PURE__ */ React.createElement(AuthContext.Provider, {
    value: { authState, signIn: signIn2, signOut }
  }, children);
};
...
var SignIn = () => {
  ...
  const { signIn: signIn2 } = useContext2(AuthContext);
  const handleSubmit2 = async (event) => {
    ...
    console.log({ email, pwd });
    try {
      const { authId, authToken } = await signIn({ email, pwd });
      console.log({ authId, authToken });
      signIn2({ authId, authToken });
      localStorage.setItem("authId", authId);
      localStorage.setItem("authToken", authToken);
      navigate("/3stats");
    } catch (err) {
  ...
  return /* @__PURE__ */ React2.createElement("main", {
  ...
  }, "Welcome back! \u2728"), /* @__PURE__ */ React2.createElement("div", {
    className: "flex items-center justify-end mt-6"
  }, /* @__PURE__ */ React2.createElement(Link, {
    className: "btn bg-indigo-500 hover:bg-indigo-600 text-white ml-3",
    to: "/"
  }, "Google"), /* @__PURE__ */ React2.createElement(Link, {
    className: "btn bg-indigo-500 hover:bg-indigo-600 text-white ml-3",
    to: "/"
  }, "Guest")), /* @__PURE__ */ React2.createElement("form", {
    ...
    htmlFor: "email"
  }, "Email Address"), /* @__PURE__ */ React2.createElement("input", {
    id: "email",
    ...
    to: "/reset-password"
  }, "Forgot Password?")), /* @__PURE__ */ React2.createElement("button", {
    type: "submit",
    className: "btn bg-indigo-500 hover:bg-indigo-600 text-white ml-3"
    ...
    className: "text-sm"
  }, "Don\u2019t you have an account? ", /* @__PURE__ */ React2.createElement(Link, {
    ...
    className: "text-sm"
  }, "To support you during the pandemic super pro features are free until March 31st."))))))), /* @__PURE__ */ React2.createElement("div", {
...
import { React as React37, useState as useState12 } from "/libs/vendors-v0.0.1.mjs";

// pnp:/home/mamluk/3pass/esm-pwa/libs/partials/src/Sidebar.mjs
import { React as React4, useState as useState3, useEffect, useRef } from "/libs/vendors-v0.0.1.mjs";
...
import { React as React3, useState as useState2 } from "/libs/vendors-v0.0.1.mjs";
var SidebarLinkGroup = ({
  children,
  activecondition
}) => {
  const [open, setOpen] = useState2(activecondition);
  const handleClick = () => {
    setOpen(!open);
  };
...
var Sidebar = ({
  ...
  const [sidebarExpanded, setSidebarExpanded] = useState3(storedSidebarExpanded);
...
import { React as React16, useState as useState10 } from "/libs/vendors-v0.0.1.mjs";
...
import { React as React5, useRef as useRef2, useEffect as useEffect2, useContext as useContext3 } from "/libs/vendors-v0.0.1.mjs";
...
var Transition = ({ show, appear, ...rest }) => {
  const { parent } = useContext3(TransitionContext);
...
import { React as React7, useState as useState4, useRef as useRef4, useEffect as useEffect4, Link as Link3 } from "/libs/vendors-v0.0.1.mjs";
...
import { React as React8, useState as useState5, useRef as useRef5, useEffect as useEffect5, Link as Link4 } from "/libs/vendors-v0.0.1.mjs";
var DropdownHelp = ({
  align
}) => {
...
import { React as React9, useState as useState6, useRef as useRef6, useEffect as useEffect6, Link as Link5 } from "/libs/vendors-v0.0.1.mjs";
...
import { React as React10, useState as useState7, useRef as useRef7, useEffect as useEffect7 } from "/libs/vendors-v0.0.1.mjs";
var DropdownFilter = ({
  align
}) => {
...
import { React as React11, useState as useState8, useRef as useRef8, useEffect as useEffect8 } from "/libs/vendors-v0.0.1.mjs";
...
import { React as React12, useState as useState9 } from "/libs/vendors-v0.0.1.mjs";
var Tooltip = ({
  children,
  className,
  bg,
  ...
  const [tooltipOpen, setTooltipOpen] = useState9(false);
...
var Datepicker = ({
  ...
  const options = {
    ...
    dateFormat: "M j, Y",
    defaultDate: [dateRange[0] * 1e3, dateRange[1] * 1e3],
    ...
    onChange: (selectedDates, dateStr, instance) => {
      if (selectedDates.length === 2) {
        const startDate = Math.round(new Date(selectedDates[0]).getTime() / 1e3);
        const endDate = Math.round(new Date(selectedDates[1]).getTime() / 1e3);
...
var Header = ({
  ...
  const [searchModalOpen, setSearchModalOpen] = useState10(false);
...
import { React as React30, useState as useState11, useEffect as useEffect17 } from "/libs/vendors-v0.0.1.mjs";
var DashboardCard05 = () => {
  const [counter, setCounter] = useState11(0);
  const [increment, setIncrement] = useState11(0);
  const [range, setRange] = useState11(35);
  const data = [
    57.81,
    57.75,
    55.48,
  ...
  const [slicedData, setSlicedData] = useState11(data.slice(0, range));
  const generateDates = () => {
    const now = new Date();
    const dates = [];
    data.forEach((v, i) => {
  ...
  const [slicedLabels, setSlicedLabels] = useState11(generateDates().slice(0, range).reverse());
  useEffect17(() => {
...
import { React as React46, useState as useState17, useEffect as useEffect20 } from "/libs/vendors-v0.0.1.mjs";

// pnp:/home/mamluk/3pass/esm-pwa/libs/layouts/dashboardLayout.mjs
import { React as React38, useState as useState13 } from "/libs/vendors-v0.0.1.mjs";
...
import { React as React40, useState as useState15, useEffect as useEffect19 } from "/libs/vendors-v0.0.1.mjs";

// pnp:/home/mamluk/3pass/esm-pwa/pkgs/3stats/dashboard/ItemFilter.mjs
import { React as React39, useState as useState14, useRef as useRef17, useEffect as useEffect18 } from "/libs/vendors-v0.0.1.mjs";
var ItemFilter = ({
  align,
  trackedItems,
  ...
  const [dropdownOpen, setDropdownOpen] = useState14(false);
  const [selectedItems, setSelected] = useState14([]);
...
var Controls = ({ query, setQuery, trackedItems, setTrackedItems: setTrackedItems2 }) => {
  const [dateRange, setDateRange] = useState15([epochSeconds() - 14 * daysInSeconds, epochSeconds()]);
  const [addLandModal2, setAddLandModal2] = useState15(false);
  const updateQuery = () => {
  ...
  useEffect19(updateQuery, [trackedItems, dateRange]);
...
var MainCard = ({ dataSet }) => {
  ...
  return /* @__PURE__ */ React41.createElement("div", {
    ...
    className: "font-semibold text-slate-800"
  }, "Analytics")), /* @__PURE__ */ React41.createElement("div", {
    className: "px-5 py-1"
...
import { React as React42, Link as Link10, useState as useState16 } from "/libs/vendors-v0.0.1.mjs";
...
var GeoCard = ({ geoDataSet }) => {
  ...
  }, count)))))), /* @__PURE__ */ React43.createElement("div", {
...
import { React as React44, Link as Link12 } from "/libs/vendors-v0.0.1.mjs";
var tableData = [
  {
    source: "Bid",
    amount: 3.2,
...
var TransactionsCard = () => {
  return /* @__PURE__ */ React44.createElement("div", {
    ...
    className: "font-semibold text-slate-800"
  }, "Transactions")), /* @__PURE__ */ React44.createElement("div", {
    className: "p-3"
    ...
    className: "font-semibold text-center"
  }, "Amount")), /* @__PURE__ */ React44.createElement("th", {
    className: "p-2"
  }, /* @__PURE__ */ React44.createElement("div", {
    className: "font-semibold text-center"
  }, "Currency")))), /* @__PURE__ */ React44.createElement("tbody", {
    className: "text-sm font-medium divide-y divide-slate-100"
  }, tableData.map(({ source, amount, currency }, index) => /* @__PURE__ */ React44.createElement("tr", {
    key: index
  }, /* @__PURE__ */ React44.createElement("td", {
    className: "p-2"
  }, /* @__PURE__ */ React44.createElement("div", {
    className: "flex items-center"
    ...
    className: "text-slate-800"
  }, source))), /* @__PURE__ */ React44.createElement("td", {
    className: "p-2"
  }, /* @__PURE__ */ React44.createElement("div", {
    className: "text-center"
  }, amount)), /* @__PURE__ */ React44.createElement("td", {
    className: "p-2"
  }, /* @__PURE__ */ React44.createElement("div", {
    className: "text-center"
  }, currency)))))))), /* @__PURE__ */ React44.createElement("div", {
    className: "text-right px-5 pb-4"
  }, /* @__PURE__ */ React44.createElement(Link12, {
    className: "text-sm font-medium text-indigo-500 hover:text-indigo-600",
    to: "#0"
  }, "Real-Time Report ->")));
};
...
import { React as React45, Link as Link13 } from "/libs/vendors-v0.0.1.mjs";
var RealTimeCard = ({ trackedItems }) => {
  const chartData = {
    labels: [
      "03-01-2023"
    ],
  ...
  return /* @__PURE__ */ React45.createElement("div", {
    ...
    className: "font-semibold text-slate-800"
  }, "Real Time Data")), /* @__PURE__ */ React45.createElement("div", {
    className: "flex flex-col h-full"
    ...
    className: "text-3xl font-bold text-slate-800 mr-2"
  }, "Upgrade to pro"), /* @__PURE__ */ React45.createElement("div", {
    className: "text-sm text-slate-500"
    ...
    className: "font-semibold text-left"
  }, "Tracked Items")), /* @__PURE__ */ React45.createElement("th", {
    className: "py-2"
  }, /* @__PURE__ */ React45.createElement("div", {
    className: "font-semibold text-right"
  }, "Active users")))), /* @__PURE__ */ React45.createElement("tbody", {
    className: "text-sm divide-y divide-slate-100"
  }, trackedItems.map((item) => /* @__PURE__ */ React45.createElement("tr", {
    key: item
  }, /* @__PURE__ */ React45.createElement("td", {
    className: "py-2"
  }, /* @__PURE__ */ React45.createElement("div", {
    className: "text-left"
  }, item)), /* @__PURE__ */ React45.createElement("td", {
    className: "py-2"
  }, /* @__PURE__ */ React45.createElement("div", {
    className: "font-medium text-right text-slate-800"
  }, "0")))))))), /* @__PURE__ */ React45.createElement("div", {
    className: "text-right px-5 pb-4"
  }, /* @__PURE__ */ React45.createElement(Link13, {
    className: "text-sm font-medium text-indigo-500 hover:text-indigo-600",
    to: "#0"
  }, "Real-Time Report ->"))));
};
...
var DashboardPage = () => {
  ...
  return /* @__PURE__ */ React46.createElement(DashboardLayout, null, /* @__PURE__ */ React46.createElement("div", {
    ...
    ...{ query, setQuery, trackedItems, setTrackedItems: setTrackedItems2 }
  })), /* @__PURE__ */ React46.createElement("div", {
    className: "grid grid-cols-12 gap-6"
